...
### 출력 
 ...
 <p>키위새가 가지 한 두름을 만들 수 있으면 <span style="color: rgb(231, 76, 60); --darkreader-inline-color: var(--darkreader-text-e74c3c, #e95849);" data-darkreader-inline-color=""><code>1</code></span>을, 만들 수 없으면 <span style="color: rgb(231, 76, 60); --darkreader-inline-color: var(--darkreader-text-e74c3c, #e95849);" data-darkreader-inline-color=""><code>0</code></span>을 출력합니다.</p>
